...
def test_request_creation(mock_socketify_request):
    request = Request(mock_socketify_request)
    assert request._req == mock_socketify_request
    assert request.params == {}


def test_request_method(mock_socketify_request):
    request = Request(mock_socketify_request)
    assert request.method == "GET"


def test_request_url(mock_socketify_request):
    request = Request(mock_socketify_request)
    assert request.url == "http://example.com/path?key=value"


def test_request_headers(mock_socketify_request):
    request = Request(mock_socketify_request)
    headers = request.headers
    assert headers == {"content-type": "application/json"}


def test_request_query(mock_socketify_request):
    request = Request(mock_socketify_request)
    assert request.query == "key=value"


def test_request_query_params(mock_socketify_request):
    request = Request(mock_socketify_request)
    params = request.query_params
    assert params == {"key": ["value"]}


def test_request_get_parameter(mock_socketify_request):
    request = Request(mock_socketify_request)
    assert request.get_parameter(0) == "param_value"


def test_request_get_header(mock_socketify_request):
    request = Request(mock_socketify_request)
...
@pytest.mark.asyncio
async def test_request_text(mock_socketify_request):
    request = Request(mock_socketify_request)
...
@pytest.mark.asyncio
async def test_request_json(mock_socketify_request):
    request = Request(mock_socketify_request)
...
def test_request_content_type(mock_socketify_request):
    request = Request(mock_socketify_request)
...
def test_request_is_json(mock_socketify_request):
    request = Request(mock_socketify_request)
